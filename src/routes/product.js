...
const { validProduct, validateGetProduct, validateId, validProductEdit } = require('../middlewares/validators')
...
router.put('/editProduct/:id', authentication, authorize, machineImage.single('prodImage'), validProductEdit, editProduct)
